-- @description Copy Filename of Selected Item and Focus Media Explorer Search
...
local function FocusMediaExplorerSearch()
    if not reaper.APIExists("JS_Window_SetFocus") then
        reaper.ShowMessageBox(
            "Focusing the Media Explorer requires the JS_ReaScriptAPI extension.",
            "Missing extension",
            0
        )
        return
