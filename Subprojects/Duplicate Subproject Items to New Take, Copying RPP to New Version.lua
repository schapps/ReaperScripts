...
-- @about
    --[[
      Duplicate Subproject Items as New Takes with Versioning (Multiple Items)
      and Open Each New Subproject in a New Tab

      For each selected media item:
        1. Uses the active take to retrieve its subproject file.
        2. Checks that the file extension is ".rpp". If not, an error is shown.
        3. Computes a new version filename (appending/incrementing _vXX) in the same folder.
          (If multiple items reference the same original file, the new version is created only once.)
        4. Copies the original subproject file to the new versioned file.
        5. Adds a new take to the item.
        6. Creates a PCM source from the new file and assigns it to the new take.
        7. Copies the original take’s start offset to the new take.
        8. Copies the original take’s name to the new take.
        9. Sets the new take as the active take.
        10. Opens the subprojects and renders them
    --]]
